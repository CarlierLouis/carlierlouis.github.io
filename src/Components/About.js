         ...
         <div className="nine columns main-col">
            ...
            <div className="row">
               ...
               <div className="columns download">
                  <p>
                     <a href="https://github.com/CarlierLouis/carlierlouis.github.io/settings/pages" target="_blank" className="button"><i className="fa fa-download"></i>Mon CV version pdf</a>
                  </p>
               </div>
            </div>
         </div>
